...
/**
 * @ngdoc directive
 * @name bprApp.directive:datetimepicker
 * @description
 * # datetimepicker
 */
/*
      ...
      return {
        ...
        template: function(elem, attrs) {
          ...
          var tmpl = "<div class=\"datetimepicker-wrapper\">" +
            "<input class=\"form-control\" type=\"text\" ng-click=\"open($event)\" is-open=\"opened\" ng-change=\"change()\"  ng-model=\"ngModel\" " + [
              ["minDate"],
              ["maxDate"],
              ["dayFormat"],
              ["monthFormat"],
        ...
        link: function(scope, element,attrs) {
          scope.change = function () {
            scope.$parent.change(scope.ngModel,scope.rangeType);
          };
