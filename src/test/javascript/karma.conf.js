...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/ngDialog/js/ngDialog.js',
            'main/webapp/bower_components/angular-touch/angular-touch.js',
            'main/webapp/bower_components/bootstrap-duallistbox/src/jquery.bootstrap-duallistbox.js',
            'main/webapp/bower_components/angular-bootstrap-duallistbox/dist/angular-bootstrap-duallistbox.js',
